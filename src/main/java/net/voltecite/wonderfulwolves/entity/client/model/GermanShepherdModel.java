package net.voltecite.wonderfulwolves.entity.client.model;
...
public class GermanShepherdModel<T extends GermanShepherd> extends ColorableAgeableListModel<T> {
    ...
    public GermanShepherdModel(ModelPart pRoot) {
