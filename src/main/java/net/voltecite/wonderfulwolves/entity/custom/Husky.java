...
public class Husky extends TamableAnimal implements NeutralMob {
    private static final EntityDataAccessor<Boolean> DATA_INTERESTED_ID = SynchedEntityData.defineId(Husky.class, EntityDataSerializers.BOOLEAN);
    ...
    public Husky(EntityType<? extends Husky> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new Husky.WolfPanicGoal(1.5D));
        this.goalSelector.addGoal(2, new SitWhenOrderedToGoal(this));
        //this.goalSelector.addGoal(3, new Husky.WolfAvoidEntityGoal<>(this, Llama.class, 24.0F, 1.5D, 1.5D));
    ...
    class WolfAvoidEntityGoal<T extends LivingEntity> extends AvoidEntityGoal<T> {
        ...
        private boolean avoidLlama(Llama pLlama) {
            return pLlama.getStrength() >= Husky.this.random.nextInt(5);
        }
         ...
         */
        public void start() {
            Husky.this.setTarget((LivingEntity)null);
            super.start();
        }
    ...
    class WolfPanicGoal extends PanicGoal {
        public WolfPanicGoal(double pSpeedModifier) {
            super(Husky.this, pSpeedModifier);
        }
